                    ...
                    <div class="col-lg">
                        ...
                        <div class="text">
                            ...
                            <div class="row justify-content-center button-grid ">
                                <div class="col-4">
                                    <input type="button" value="Buy" class="btn btn-warning Buy" onclick="Add_to_Cart('buy')" />
                                </div>
                                <div class="col-4">
                                    <input type="button" value="Add to Cart" class="btn btn-outline-primary AddtoCart" onclick="Add_to_Cart('cart')"/>
                                </div>
                            </div>
                        </div>
