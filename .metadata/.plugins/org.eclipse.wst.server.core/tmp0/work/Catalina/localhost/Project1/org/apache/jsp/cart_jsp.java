 ...
 * Generated at: 2023-01-09 12:31:13 UTC
...
public final class cart_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                        <div class = \"about-head\">\r\n");
      out.write("                        \r\n");
      out.write("                            <div class = \"Cart-Container\">\r\n");
      out.write("                                <div class = \"Header-cart\">\r\n");
      out.write("                                    <h3 class = \"Heading-cart\">Shopping cart</h3>\r\n");
      ...
      out.write("        var size = document.getElementsByClassName(\"subtitle-cart\");\r\n");
      out.write("\r\n");
      ...
      out.write("            var pri = parseInt(prices[i].innerHTML);\r\n");
      out.write("            amount[i] = inp * pri;\r\n");
      out.write("            console.log(i, inp, pri, amount[i]);\r\n");
      out.write("            amt[i].innerHTML = amount[i];\r\n");
      out.write("            tot += amount[i];\r\n");
      out.write("            \r\n");
      out.write("            var lastTwoChars = size[i].innerHTML.substring(size[i].innerHTML.length - 2);\r\n");
      out.write("            var trimmedLastTwoChars = lastTwoChars.trim();\r\n");
      out.write("            \r\n");
      out.write("            \r\n");
      ...
      out.write("            var params = \"pid=\" + pid[i].innerHTML + \"&\" + \"size=\" + trimmedLastTwoChars +\"&\" + \"qty=\" + inputs[i].value + \"&\" + \"job=quantity\"; \r\n");
      ...
      out.write("        }\r\n");
      out.write("        \r\n");
      out.write("        document.getElementById(\"tot-amount\").innerHTML = \"Total: \" + tot;\r\n");
      ...
      out.write("        if (y === 'all')\r\n");
      out.write("        {\r\n");
      out.write("        	$(\".Cart-Items\").next().remove();\r\n");
      out.write("        	$(\".Cart-Items\").remove();\r\n");
      out.write("        	\r\n");
      out.write("            var params = \"qty=all\" + \"&\" + \"job=remove\" ; \r\n");
      out.write("            \r\n");
      out.write("            var message = document.getElementById(\"no-items\");\r\n");
      out.write("            message.style.margin = \"30px\";\r\n");
      out.write("            message.innerHTML = \"There are no items in the cart currently.\";\r\n");
      out.write("			\r\n");
      ...
      out.write("        	\r\n");
      out.write("            document.getElementById(\"tot-amount\").innerHTML = \"Total: \" + 0;\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("        }\r\n");
      out.write("        else\r\n");
      out.write("        {\r\n");
      out.write("        	y.parentElement.parentElement.parentElement.nextElementSibling.remove();\r\n");
      out.write("        	y.parentElement.parentElement.parentElement.remove();\r\n");
      out.write("        	\r\n");
      out.write("        	var cartItem = y.closest(\".Cart-Items\");\r\n");
      out.write("        	var pid = cartItem.querySelector(\".pid\").textContent;\r\n");
      out.write("        	var size = cartItem.querySelector(\".subtitle-cart\").textContent;\r\n");
      out.write("        	var lastTwoChars = size.substring(size.length - 2);\r\n");
      out.write("            var trimmedLastTwoChars = lastTwoChars.trim();\r\n");
      out.write("        	\r\n");
      out.write("            var params = \"pid=\" + pid + \"&\" + \"size=\" + trimmedLastTwoChars + \"&\" + \"qty=one\" + \"&\" + \"job=remove\" ; \r\n");
      out.write("            \r\n");
